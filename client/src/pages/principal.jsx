  ...
  return (
    <div className="container_principal">
      <header className="header_principal">
        ...
        />
        <div className="titulo_escu">
          <h1 className="titulo-h1">Escuela Técnica</h1>
          <h1 className="titulo-h1">“Monseñor Estanislao Carrillo”</h1>
        </div>
      </header>
      <DivisionPag texto="Sobre Nosotros" />
      <main className="main_escu">
