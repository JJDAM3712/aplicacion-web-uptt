...
function IconBase(props) {
  var elem = function(conf) {
    var attr2 = props.attr, size4 = props.size, title = props.title, svgProps = __rest(props, ["attr", "size", "title"]);
...
// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponentFn = (0, import_react8.forwardRef)(({ children, className, color = "info", disabled, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner, gradientDuoTone, gradientMonochrome, label, outline = false, pill = false, positionInGroup = "none", size: size4 = "md", theme: customTheme = {}, ...props }, ref) => {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size4], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size4 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)(RatingContext.Provider, { value: { theme: theme2, size: size4 }, children: (0, import_jsx_runtime68.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
